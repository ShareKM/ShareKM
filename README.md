...
>[!WARNING]
>The **OpenKMAP** packages offer open-source code to disseminate basic and advanced tracer kinetic modeling approaches in a timely matter. The packages DO NOT aim to provide a comprehensive software solution for end users. Commercial software (e.g. PMOD) may provide a better solution for the latter purpose.
>
>Both KMAP-C and KMAP-M are continually being updated. The development team is working on adding new models, optimizing performance, and expanding the functionality. These packages are provided “as is” without warranty.
